<div>
    ...
    <div class="pt-6 w-[512px] space-y-6">
        ...
        <a href="{{ route('data') }}" wire:navigate
            class="flex flex-row items-center bg-blue-500 border-b-4 border-b-blue-700 active:border-b-0 w-fit px-4 py-2 rounded-xl text-white">
            ...
            <span class="text-lg ml-2 font-medium">Lampiran</span>
