...
@section('content')
    ...
    <div class="flex flex-col space-y-2 lg:pt-4">
        ...
        <article class="prose prose-slate mx-auto lg:prose-lg prose-a:underline prose-p:text-justify">
            <p>
                Menurut
    ...
    <a href="{{ route('attachments') }}"
        ...
        <span class="ml-1.5 text-base tracking-wide lg:text-lg">Lampiran</span>
    </a>
@endsection
